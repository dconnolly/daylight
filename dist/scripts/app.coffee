...
define ['../../components/d3/d3.v2.min'], () ->
    
    yAxisLabel = (d) ->
        return "noon"  if d is 12
        return d  if d < 12
        return d - 12
    ...
    # This isn't very DRY but whatever.
    daylight.
    ...
    daylight.
        append("svg:path").
        attr("d", daylightGraph(data)).
        #attr("transform", "translate("+ padding + ", " + padding + ")").
        attr('class', 'daylight-graph').
        attr("width", width).
        attr("height", height)
    ...
    daylight.on "mouseover", () ->
        focusSunrise.style "display", null
        focusSunset.style "display", null
        focusDetails.style 'display', null
        
    daylight.on "mouseout", () ->
        focusSunrise.style "display", "none"
        focusSunset.style "display", "none"

    daylight.on "mousemove", () ->
        ...
        focusSunrise.
            attr("transform", "translate("+ x(d.date) + ", " + y(d.sunrise) + ")").
            select('text').
            text(dayString + " - " + d.sunrise[0] + ":" + d.sunrise[1])
            
        focusSunset.
            attr("transform", "translate("+ x(d.date) + ", "  + y(d.sunset) + ")").
            select('text').
            text(dayString + " - " + d.sunset[0] + ":" + d.sunset[1])

        focusDetails.
            attr('transform', "translate(" + x(d.date) + ", " + height/2 + ")").
            select('text').
            text(dayString)
